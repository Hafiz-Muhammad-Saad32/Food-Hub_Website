export const verifyEmailTemplate = (verifyUrl: string) => {
  const orange500 = "#f97316"; // Your Orange
  const slate900 = "#0f172a"; // Your Slate-900
  const slate50 = "#f8fafc"; // Premium light card color
...
export const orderConfirmationTemplate = (order: any) => {
  ...
  const orange500 = "#f97316"; // Your Orange
  const slate900 = "#0f172a"; // Your Slate-900
  const slate50 = "#f8fafc"; // Premium light background

  // Improved item mapping with better styling
