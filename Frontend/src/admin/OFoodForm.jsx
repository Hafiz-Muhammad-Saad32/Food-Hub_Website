...
export default function FoodForm({ foods, setFoods }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(
        "❌ Error: " + (err.response?.data?.message || "Failed to save food"),
      );
      setTimeout(() => setSuccessMessage(""), 3000);
    } finally {
      setLoading(false);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setSuccessMessage(
        "❌ Error: " + (err.response?.data?.message || "Failed to delete food"),
      );
      setTimeout(() => setSuccessMessage(""), 3000);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-light py-12">
      <div className="container-custom">
        ...
        {successMessage && (
          <div
            className={`mb-6 border-2 px-6 py-4 rounded-lg animate-slideDown ${
                      ...
                      >
                        <td className="px-4 py-3">
                          <div className="flex gap-3 items-center">
                            ...
                            />
                            <div>
                              <p className="font-bold text-dark">{food.name}</p>
        ...
        <div className="mt-12 bg-green-100 border-2 border-green-400 rounded-lg p-6">
          ...
          <ul className="text-green-800 space-y-2 text-sm">
            <li>
              ✓ All operations (ADD, UPDATE, DELETE, VIEW) connected to backend
              API
            </li>
