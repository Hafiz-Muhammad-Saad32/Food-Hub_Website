        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              Bringing the city's finest flavors to your doorstep. 
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-orange-500 mb-4">Explore</h3>
          ...
          {/* Support */}
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-orange-500 mb-4">Support</h3>
            <ul className="space-y-2 text-sm font-bold text-slate-300">
          ...
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-xs font-black uppercase tracking-[0.2em] text-orange-500 mb-4">Get In Touch</h3>
            <ul className="space-y-2 text-sm font-bold text-slate-300">
              <li className="flex items-center gap-2"><span>📞</span> (555) 123-4567</li>
              <li className="flex items-center gap-2"><span>📧</span> support@foodhub.com</li>
              <li className="text-slate-500 font-medium text-xs mt-2">Open 24/7 for your cravings.</li>
            </ul>
          </div>
        </div>
